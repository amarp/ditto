...
# -1 = solid(black), 1 = solid(red), 2 = dashed(green), 3 = dotted(blue), 6 = dotted and dashed, 8 = dash-dot-dot(orange)

line_styles << "lt 3 lw 3"
line_styles << "lt -1 lw 2"
line_styles << "lt 0 lw 4"
line_styles << "lt 8 lw 3"
line_styles << "lt 2 lw 3"
line_styles << "lt 6 lw 3"
...
if ARGV.size < 1
    puts "Usage: ./graph_xput_improvement_fixed_chunk_size.rb <results_dir - the directory which has \"results\">"
...
set size 0.65
set output '#{GRAPH_DIR}/xput_improvement_#{chunk_size}_#{gtype}.eps'
#set title "#{chunk_size}"
set xlabel "Throughput (Kbps)"
#set ylabel "% observers"
set ylabel "% receivers"
#set xrange [0:100]
set log x
set yrange [0:100]
